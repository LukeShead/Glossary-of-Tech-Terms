...
Procedural programs are about functions and how they interacted, procedural programs will have procedures that will have functions interacting with each other in order to complete it's own functions. The functions will a
